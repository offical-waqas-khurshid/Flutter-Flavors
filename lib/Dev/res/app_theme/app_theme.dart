...
ThemeData appThemeDev() {
  return ThemeData(
   ...
   /// Titles And Text Theme
    ...
    /// Card Theme
    cardTheme: CardTheme(
      color: Get.isDarkMode ? AppColors.currency : AppColors.textColor,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(AppDimensions.borderRadius),
      ),
      elevation: AppDimensions.horizontalPadding,
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
        ...
        iconColor: Get.isDarkMode ? AppColors.loanCard : AppColors.loanCard),
    ...
    textButtonTheme: TextButtonThemeData(
        style: ButtonStyle(
          minimumSize: MaterialStateProperty.all<Size>(
              Size(AppDimensions.appBarImageWidth, AppDimensions.appBarToolBarHeight)),
    ...
    checkboxTheme: CheckboxThemeData(
      checkColor: MaterialStateProperty.all<Color>( Get.isDarkMode ? AppColors.loanCard : AppColors.loanCard),
      fillColor: MaterialStateProperty.all<Color>(Get.isDarkMode ? AppColors.loanCard : AppColors.loanCard),
      //splashRadius: 10,
      shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(AppDimensions.borderRadius)),
      visualDensity: VisualDensity.compact,
      side: BorderSide(
        color: Get.isDarkMode ? AppColors.loanCard : AppColors.loanCard,
        width: AppDimensions.appBarImageWidth,
